...
public class RadianceAura {
    ...
    public static void Burn (Player player, Level world) {
        ...
        List<LivingEntity> _entfound = world.getEntitiesOfClass(LivingEntity.class, new AABB(center, center).inflate(16 / 2d), e -> true).stream().sorted(Comparator.comparingDouble(_entcnd -> _entcnd.distanceToSqr(center))).toList();
